    ...
    <div class="container-fluid">
        ...
        <div class="row gx-2" id="photoGalleryContainer">
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image1_small.png') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image1_small.png') }}",
            ...
            <div class="col-6 gallery-item section-sub-title mb-2 btn-see-more-gallery" data-aos="fade-right"
                data-index="0"> <img src="{{ asset('images/wedding/gallerries/image1_small.png') }}" />
            </div>
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image2_small.png') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image2_small.png') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image3_small.png') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image3_small.png') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image4_small.png') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image4_small.png') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image5_small.png') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image5_small.png') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    ...
                    thumb: "{{ asset('images/wedding/gallerries/image6_small.png') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    ...
                    thumb: "{{ asset('images/wedding/gallerries/image7_small.png') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image8_small.png') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image8_small.png') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image9_small.png') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image9_small.png') }}",
