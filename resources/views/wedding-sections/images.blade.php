    ...
    <div class="container-fluid">
        ...
        <div class="row gx-2" id="photoGalleryContainer">
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image1.jpg') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image1.jpg') }}",
            ...
            <div class="col-6 gallery-item section-sub-title mb-2 btn-see-more-gallery" data-aos="fade-right"
                data-index="0"> <img src="{{ asset('images/wedding/gallerries/image1.jpg') }}" />
            </div>
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image2.jpg') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image2.jpg') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image3.jpg') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image3.jpg') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image4.jpg') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image4.jpg') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image5.jpg') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image5.jpg') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image6.jpg') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image6.jpg') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image7.jpg') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image7.jpg') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image8.jpg') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image8.jpg') }}",
            ...
            <script type="text/javascript">
                photoGalleries.push({
                    src: "{{ asset('images/wedding/gallerries/image9.jpg') }}",
                    thumb: "{{ asset('images/wedding/gallerries/image9.jpg') }}",
